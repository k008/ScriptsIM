...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=xlWbk.getCellByPosition(12,6).String & Sep & xlWbk.getCellByPosition(12,8).String & Sep & ""

  DeviceOut.WriteLine(St)
  DeviceOut.WriteLine "[Body]"
  i=19 
  Do While xlWbk.getCellByPosition(14,i).String<>""
      if InStr(xlWbk.getCellByPosition(14,i).String,"Цена") then
        i=i+3
      end if	
      if Not ((xlWbk.getCellByPosition(14,i).String="Х") or InStr(xlWbk.getCellByPosition(14,i).String,"Страница")>0) then
        St=xlWbk.getCellByPosition(2,i).String & Sep & xlWbk.getCellByPosition(1,i).String & Sep & Sep & Sep & Sep &_
	    xlWbk.getCellByPosition(9,i).String & Sep & xlWbk.getCellByPosition(10,i).String & Sep & Sep & xlWbk.getCellByPosition(10,i).String & Sep &_
		Sep & "0" & Sep & Sep & Sep & Sep & Sep & Sep & Sep &_
		Sep & Sep & Sep & Sep & xlWbk.getCellByPosition(14,i).String & Sep
        i = i+1
