 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  dbfPrice.MoveNext  
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("KODN") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("NIZG") & Sep & Sep &_
	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL") & Sep & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL")-dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL")/(dbfPrice.Fields("NDS")+100)*dbfPrice.Fields("NDS") & Sep &_
		Sep & "0" & Sep & Sep & dbfPrice.Fields("GTD") & Sep &_
		Sep & Mid(dbfPrice.Fields("SER"),1,InStr(dbfPrice.Fields("SER"),",")-1) & Sep & Sep & dbfPrice.Fields("GODEN") & Sep &_
