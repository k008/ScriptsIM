 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
	  St = dbfPrice("CODE") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("COUNTRY") & Sep &dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("PRPSNDS") & Sep & dbfPrice.Fields("PRZSNDS") & Sep & dbfPrice.Fields("PRP") & Sep & Sep & Sep & Sep & dbfPrice.Fields("GTD") & Sep & ReplaceStr(ReplaceStr(dbfPrice.Fields("SERT"),Chr(13),""),Chr(10)," ") & Sep & Sep & Sep & dbfPrice.Fields("SROKG") & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMSNDSP") & Sep & ""
          St=Convert866to1251(St)
          DeviceOut.WriteLine(St)
	  dbfPrice.MoveNext
