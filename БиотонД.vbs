 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
	  St = dbfPrice("KOD") & Sep & ReplaceStr(ReplaceStr(ReplaceStr(dbfPrice.Fields("NAME"),Chr(13),""),Chr(10)," "),Sep,",") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
		...
		dbfPrice.Fields("SERII") & Sep & Sep & dbfPrice.Fields("DATAEND") & Sep & Sep &_
		dbfPrice.Fields("REESTR") & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & ""
          St=Convert866to1251(St)
          DeviceOut.WriteLine(St)
	  dbfPrice.MoveNext
