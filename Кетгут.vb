  ...
  dbfPrice.MoveNext  
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("KODN") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("NIZG") & Sep & Sep &_
	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("CENA") & Sep & dbfPrice.Fields("CENIZG") & Sep & dbfPrice.Fields("CENIZG") & Sep &_
		Sep & "0" & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("SER") &_
