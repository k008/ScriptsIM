...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("NOM_DOC") & Sep & dbfPrice.Fields("DATA_DOC") & Sep & dbfSum("Summ")
  ...
  'dbfPrice.MoveNext
    ...
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("CODE_TOVAR") & Sep & dbfPrice.Fields("NAME_TOVAR") & Sep & dbfPrice.Fields("PROIZ") & Sep & dbfPrice.Fields("COUNTRY") & Sep & dbfPrice.Fields("VOLUME") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("VOLUME") & Sep & dbfPrice.Fields("PRICE_PROI") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("VOLUME")-dbfPrice.Fields("SUMMA")/dbfPrice.Fields("VOLUME")/(100+dbfPrice.Fields("PCT_NDS"))*dbfPrice.Fields("PCT_NDS") & Sep & Sep & "0" & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("DOCUMENT") & "^" & dbfPrice.Fields("REG_NUM") & "^" & dbfPrice.Fields("KAL") & Sep & dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROK") & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep
