...
For Each FF in FL
 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  'DeviceOut.WriteLine Convert866to1251(dbfPrice.Fields("NOMDOK")) & Sep & dbfPrice.Fields("DATADOK") & Sep & dbfPrice.Fields("SUMDOK")
  DeviceOut.WriteLine Convert866to1251(delZero(dbfPrice.Fields("NOMDOK"))) & Sep & dbfPrice.Fields("DATADOK") & Sep & dbfPrice.Fields("SUMDOK")
  DeviceOut.WriteLine "[Body]"
  
    Do While Not dbfPrice.Eof
	  St=dbfPrice.Fields("KODTOV") & Sep & dbfPrice.Fields("TOVAR") & Sep & dbfPrice.Fields("PROD") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
  	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("PRICE") & Sep & Sep & Replace(dbfPrice.Fields("PRICE"),".",",")*100/(100 + dbfPrice.Fields("NDS")) & Sep &_
		Sep & Sep & Sep &  Sep &_
		dbfPrice.Fields("SERTIF") & "^" & dbfPrice.Fields("SERTEMISS") & " " & dbfPrice.Fields("DATASERT") & " " & dbfPrice.Fields("SERTVOID") & Sep &_
		dbfPrice.Fields("SER") & Sep & Sep & dbfPrice.Fields("BESTBEFORE") & Sep & Sep & Sep &_
		Sep & Sep & dbfPrice.Fields("SUM") & Sep
          dbfPrice.MoveNext
