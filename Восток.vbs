...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("NUMB") & Sep & dbfPrice.Fields("DATE") & Sep & dbfSum.Fields("Summ")
  St=Convert866to1251(St)
  DeviceOut.WriteLine(St)
  DeviceOut.WriteLine "[Body]"
  
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("N") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("PROD") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("CENA_IZG") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL")*100/(dbfPrice.Fields("NDS")+100) & Sep &_
		Sep & dbfPrice.Fields("NCS") & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("REG") & "^" & dbfPrice.Fields("SERTIF") &_
		Sep & dbfPrice.Fields("SER") & Sep & Sep & dbfPrice.Fields("GODN") & Sep & dbfPrice.Fields("BARCODE") &_
		Sep & Sep & Sep & dbfPrice.Fields("CENA_REG") & Sep & dbfPrice.Fields("SUMMA") & Sep & dbfPrice.Fields("LV")
