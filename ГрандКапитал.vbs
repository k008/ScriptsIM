...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("BILLNUM") & Sep & dbfPrice.Fields("DATEDOC") & Sep & dbfPrice.Fields("TSUMPAY")
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Pb7=dbfPrice.Fields("PRICE1")
    Pb8=dbfPrice.Fields("PRICE2N")
    Pb9=""
    Pb10=dbfPrice.Fields("NDS")
    Pb11=""
    Pb12=dbfPrice.Fields("NUMGTD")
    Pb13=dbfPrice.Fields("SERTIF") & "^" & dbfPrice.Fields("SERTGIVE") & "^" & dbfPrice.Fields("SERTORG") & "^" & dbfPrice.Fields("SERTDATE")
