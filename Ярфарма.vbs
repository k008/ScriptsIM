...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("DOCNUMBER") & Sep & dbfPrice.Fields("DOCDATE") & Sep & dbfPrice.Fields("SOITOGWNDS")
  St=Convert866to1251(St)
  DeviceOut.WriteLine St
  DeviceOut.WriteLine "[Body]"
      
    Do While Not dbfPrice.Eof
    Pb1=dbfPrice.Fields("TOVCOD")
    Pb2=dbfPrice.Fields("TOVNAME")
    Pb3=dbfPrice.Fields("FABRNAME")
    Pb4=dbfPrice.Fields("COUNTRY")
    Pb5=dbfPrice.Fields("QUANTITY")
    Pb6=dbfPrice.Fields("POPTWNDS")
    Pb7=dbfPrice.Fields("PFABRNONDS")
    Pb8=dbfPrice.Fields("POPTNONDS")
    Pb9=""
    Pb10=dbfPrice.Fields("NDS")
    Pb11=""
    Pb12=dbfPrice.Fields("NUMBERGTD")
    Pb13=dbfPrice.Fields("CERTIF") & "^" & dbfPrice.Fields("CERTIFDATE") & "^" & dbfPrice.Fields("CERTIFLAB") & "^"
    Pb14=dbfPrice.Fields("SERIA")
    Pb15=""
    Pb16=dbfPrice.Fields("SROKG")
    Pb17=dbfPrice.Fields("BARCODE")
    Pb18=""
    Pb19=dbfPrice.Fields("RPRICE")
    Pb20=""
    Pb21=dbfPrice.Fields("SOPTWNDS")
    Pb22=dbfPrice.Fields("JV")
