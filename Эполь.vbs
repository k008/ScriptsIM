...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  'dbfPrice.MoveNext
   ...
   St=dbfPrice.Fields("CODEPST") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("FIRM") & Sep & dbfPrice.Fields("CNTR") & Sep & dbfPrice.Fields("QNT") & Sep & dbfPrice.Fields("PRICE2") & Sep & Sep & dbfPrice.Fields("PRICE1") & Sep & Sep & Sep & Sep & dbfPrice.Fields("NUMGTD") & Sep & dbfPrice.Fields("SERTIF") & "^" & dbfPrice.Fields("SERTDATE") & "^" & dbfPrice.Fields("SERTORG") & Sep & dbfPrice.Fields("SER") & Sep & Sep & dbfPrice.Fields("GDATE") & Sep & dbfPrice.Fields("EAN13") & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMPAY") & Sep & Sep
