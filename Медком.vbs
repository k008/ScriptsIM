 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("IZGOT") & Sep & dbfPrice.Fields("STRANA") & Sep & dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO") & Sep & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO")-dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO")/(dbfPrice.Fields("NDS")+100)*dbfPrice.Fields("NDS") & Sep & Sep & "0" & Sep & Sep & dbfPrice.Fields("NOMERGTD") & Sep & dbfPrice.Fields("NOMSERT") & "^" & dbfPrice.Fields("ORGSERT") & "^" & dbfPrice.Fields("SROKSERT") & Sep & dbfPrice.Fields("SERIJA") & Sep & Sep & dbfPrice.Fields("SROKGOD") & Sep & dbfPrice.Fields("SHTRIHKOD") & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep
