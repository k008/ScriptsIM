 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
	  St = dbfPrice("NAME") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("STRANA") & Sep &dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("CENASNDS") & Sep & Sep & dbfPrice.Fields("CENASNDS")-dbfPrice.Fields("CENASNDS")/(dbfPrice.Fields("NDS")+100)*dbfPrice.Fields("NDS") & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SERT") & "^" & Sep & Sep & Sep & dbfPrice.Fields("DATE_END") & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & ""
          St=Convert866to1251(St)
          DeviceOut.WriteLine(St)
	  dbfPrice.MoveNext
