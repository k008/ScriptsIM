...
'  msgbox(FF)
  ...
  St=dbfPrice.Fields("NOMERSF") & Sep & dbfPrice.Fields("DATADOK") & Sep & dbfPrice.Fields("SUM_DOC")
  ...
  Do While Not dbfPrice.Eof
    ...
    Pb2=dbfPrice.Fields("NOM")
    Pb3=dbfPrice.Fields("FIRM")
    Pb4=dbfPrice.Fields("CNTR")
    Pb5=dbfPrice.Fields("KOL")
    Pb6=dbfPrice.Fields("CEN")
    Pb7=dbfPrice.Fields("CEN_IZG")
    Pb8=dbfPrice.Fields("CENNONDS")
    Pb9=""
    Pb10=dbfPrice.Fields("NDS_ST")
    Pb11=""
    Pb12=dbfPrice.Fields("GTD")
    Pb13=dbfPrice.Fields("SERT") & "^" & "" & "^" & dbfPrice.Fields("SERT_KON")
    Pb14=dbfPrice.Fields("SERT")
    Pb15=""
