...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("NOMER_D") & Sep & dbfPrice.Fields("DATA_D") & Sep '& dbfSum("ALL_ITOG")
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
		...
		dbfPrice.Fields("SERTIF_N") & "^" & dbfPrice.Fields("SERTIF_D") & " " & dbfPrice.Fields("SERTIF_F") & "^" & dbfPrice.Fields("SROK") &_
		Sep & dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROK") & Sep &_
		Sep & Sep & Sep &_
		Sep & dbfPrice.Fields("SUM_ITOG") & Sep
