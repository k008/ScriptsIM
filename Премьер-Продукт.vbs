 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
          St = dbfPrice.Fields("CODE") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("FACTORY") & Sep & Sep & dbfPrice.Fields("QUANTITY") & Sep & dbfPrice.Fields("PRICE_MAKE") & Sep & Sep & dbfPrice.Fields("PRICE_MAKE")*100/(100+dbfPrice.Fields("NDS_PR")) & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SRT_NUM") & "^" & dbfPrice.Fields("SRT") & Sep & dbfPrice.Fields("SERIES") & Sep & Sep & dbfPrice.Fields("DATE_VALID") & Sep & dbfPrice.Fields("SCANCODE") & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & ""
	  dbfPrice.MoveNext
