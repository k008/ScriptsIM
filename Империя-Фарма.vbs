...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("N_NAKL") & Sep & dbfPrice.Fields("D_NAKL") & Sep & dbfPrice.Fields("SUMM")
  ...
  'dbfPrice.MoveNext
   ...
   St=dbfPrice.Fields("CODE") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("FACTORY") & Sep & dbfPrice.Fields("COUNTRY") & Sep &dbfPrice.Fields("QUANTITY") & Sep & dbfPrice.Fields("PRICE") & Sep &dbfPrice.Fields("PRICE_MAKE") & Sep & dbfPrice.Fields("PRICE_NAKE") & Sep & Sep & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("SERT") & "^" & dbfPrice.Fields("ORGAN") & Sep & dbfPrice.Fields("SERIES") & Sep & Sep & dbfPrice.Fields("DEND") & Sep & dbfPrice.Fields("SCANCOD") & Sep & Sep & dbfPrice.Fields("PRICE_REES") & Sep & Sep & dbfPrice.Fields("SUM_SNDS") & Sep & dbfPrice.Fields("ISLIFE") & Sep
