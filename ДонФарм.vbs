  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
	  St=Sep & dbfPrice.Fields("NAME_TOVAR") & Sep & dbfPrice.Fields("PROIZ") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
  	    dbfPrice.Fields("VOLUME") & Sep & dbfPrice.Fields("PRICE") & Sep & dbfPrice.Fields("NACENKA") & Sep & dbfPrice.Fields("PRICE")-dbfPrice.Fields("SUMMA_NDS")/dbfPrice.Fields("VOLUME") & Sep &_
		...
		dbfPrice.Fields("GOS_R") & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & Abs(CInt(dbfPrice.Fields("ZV")))
          dbfPrice.MoveNext
