...
'    msgbox("FF: " & FF & Chr(13)&Chr(10) & "Ne: " & FFNew)
  ...
  ZV = 0
    ...
    St=Mid(dbfPrice.Fields("NOM_DOC"), 6, 5) & Sep & dbfPrice.Fields("DATE_DOC") & Sep & dbfSum.Fields("Summ")
    ...
    Pb1=dbfPrice.Fields("KOD")
    Pb2=dbfPrice.Fields("NAME_TOVAR")
    Pb3=dbfPrice.Fields("PROIZV")
    Pb4=dbfPrice.Fields("Country")
    Pb5=dbfPrice.Fields("KOLVO")
    Pb6=dbfPrice.Fields("Price")
    Pb7=""
    Pb8=dbfPrice.Fields("PRICE_WO")
    Pb9=""
    Pb10=dbfPrice.Fields("PCT_NDS")
    Pb11=""
    Pb12=dbfPrice.Fields("GTD")
    Pb13=dbfPrice.Fields("Sert")
    Pb14=dbfPrice.Fields("Seria")
    Pb15=""
    Pb16=dbfPrice.Fields("SROK")
    Pb17=""
    Pb18=""
    Pb19=""
    Pb20=""
