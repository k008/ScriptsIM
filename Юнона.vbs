...
'   FSO.CopyFile FDir&FF.Name, FDir&Mid(FF.Name,1,InStr(FF.Name,".")-1) & "." & InExt
  ...
  'dbfPrice.MoveNext  
    Do While Not dbfPrice.Eof
      ...
      St=dbfPrice.Fields("KOD") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
	    dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("CENAPROIZ") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO")-dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO")/(dbfPrice.Fields("NDSPOSTAV")+100)*dbfPrice.Fields("NDSPOSTAV") & Sep & Sep & "0" & Sep & Sep & Sep & dbfPrice.Fields("SERTIF") &_
		Sep & dbfPrice.Fields("SERII") & Sep & Sep & dbfPrice.Fields("DATAEND") & Sep &_
		Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep
