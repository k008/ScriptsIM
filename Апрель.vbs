...
Dim TableName,dbfPrice,dbfConn,ZV,ErrC, WSHShell
...
For Each FF in FL
 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("NOMER") & Sep & dbfPrice.Fields("DAT_NAKL") & Sep & dbfPrice.Fields("ALL_ITOG")
  St=Convert866to1251(St)
  DeviceOut.WriteLine St
  DeviceOut.WriteLine "[Body]"
  
    Do While Not dbfPrice.Eof
          St=dbfPrice.Fields("KOD_T")&Sep & dbfPrice.Fields("NAME_T") & Sep & dbfPrice.Fields("NAME_VE") & Sep & dbfPrice.Fields("NAME_CO") & Sep &_
  	        dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("W_NDS_PR") & Sep & dbfPrice.Fields("ZAVOD_PR") & Sep & dbfPrice.Fields("NO_NDS_PR") & Sep &_
		Sep & dbfPrice.Fields("ZAVOD_NC") & Sep & Sep & dbfPrice.Fields("GTD") & Sep &_
		dbfPrice.Fields("SERTIF_N")& "^" & dbfPrice.Fields("SERTIF_F") & "^" & dbfPrice.Fields("SROK") & Sep &_
		dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROK") & Sep & dbfPrice.Fields("SCAN_CODE") & Sep & Sep &_
		Sep & Sep & dbfPrice.Fields("SUM_ITOG") & Sep
	  dbfPrice.MoveNext
