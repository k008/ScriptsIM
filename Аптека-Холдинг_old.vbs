  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
	  if Trim(dbfPrice.Fields("NG"))="Ж" then
		...
		Sep & "0" & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("SERIA") & "^" &_
		dbfPrice.Fields("SERTIF") & "^" & dbfPrice.Fields("SERTOT") & " " & dbfPrice.Fields("SERIA") & "^" & dbfPrice.Fields("SERTDO") &_
