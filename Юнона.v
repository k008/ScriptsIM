...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("KOD") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
	    dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO") & Sep & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO")-dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOLVO")/(dbfPrice.Fields("NDSPOSTAV")+100)*dbfPrice.Fields("NDSPOSTAV") & Sep & Sep & "0" & Sep & Sep & dbfPrice.Fields("N_DECLAR") & Sep & dbfPrice.Fields("SERTIF") & Sep & dbfPrice.Fields("SERII") & Sep & Sep & dbfPrice.Fields("DATAEND") & Sep &_
