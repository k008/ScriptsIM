...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=xlWbk.getCellByPosition(1,1).String & Sep & xlWbk.getCellByPosition(6,14).String & Sep & ""

  DeviceOut.WriteLine(St)
  DeviceOut.WriteLine "[Body]"
  i=9 
  Do While xlWbk.getCellByPosition(15,i).String<>""
      if InStr(xlWbk.getCellByPosition(15,i).String,"Цена") then
        i=i+3
      end if	
      if Not ((xlWbk.getCellByPosition(15,i).String="Х") or InStr(xlWbk.getCellByPosition(15,i).String,"Страница")>0) then
        St=Sep & Sep & xlWbk.getCellByPosition(2,i).String & Sep & Sep & Sep &_
	    xlWbk.getCellByPosition(3,i).String & Sep & xlWbk.getCellByPosition(4,i).String & Sep & Sep & xlWbk.getCellByPosition(5,i).String & Sep &_
		Sep & "0" & Sep & Sep & Sep & Sep & Sep & Sep & Sep &_
		Sep & Sep & Sep & Sep & xlWbk.getCellByPosition(5,i).String & Sep
        i = i+1
