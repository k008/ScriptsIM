...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=TableName & Sep & dbfPrice.Fields("SROK") & Sep & dbfSum("Summ")
  ...
  dbfPrice.MoveNext
   ...
   St=dbfPrice.Fields("ARTIKUL") & Sep & dbfPrice.Fields("TOVAR") & Sep & dbfPrice.Fields("IZGOT") & Sep & dbfPrice.Fields("STRANA") & Sep &dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("CENA") & Sep &dbfPrice.Fields("CENAIZG") & Sep & dbfPrice.Fields("CENA") & Sep & Sep & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("SERTIF") & Sep & dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROK") & Sep & Sep & Sep & dbfPrice.Fields("CENAREE") & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & Sep
