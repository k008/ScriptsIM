 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  dbfSum.Open "SELECT Count(NAME_TV) AS Summ FROM "&TableName
    Do While Not dbfPrice.Eof
      ...
      St=dbfPrice.Fields("COD_TV") & Sep & dbfPrice.Fields("NAME_TV") & Sep & dbfPrice.Fields("IZGOT") & Sep & dbfPrice.Fields("STRANA") & Sep &_
	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("CENA") & Sep & dbfPrice.Fields("CENA_Z") & Sep & dbfPrice.Fields("CENA_Z") & Sep &_
		Sep & dbfPrice.Fields("NAC") & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("SER") & "^" &_
		dbfPrice.Fields("PROT") & Sep & dbfPrice.Fields("SER") & Sep & Sep & dbfPrice.Fields("DATA_GOOD") & Sep &_
