...
For Each FF in FL
 ...
 if InStr(LCase(FF.Name),"."&InExt) AND FF.Size<50000 then
  ...
  DeviceOut.WriteLine dbfPrice.Fields("NDOC") & Sep & dbfPrice.Fields("DATEDOC") & Sep & dbfSum.Fields("Summ")
  DeviceOut.WriteLine "[Body]"
    Do While Not dbfPrice.Eof
          St=dbfPrice.Fields("CODENAME") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("MANUF") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
  	        dbfPrice.Fields("QNT") & Sep & dbfPrice.Fields("PRICE") & Sep &  Sep & dbfPrice.Fields("PRICE1") & Sep &_
		...
		dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROKSERIA") & Sep & Sep & Sep &_
