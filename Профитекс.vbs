...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("TOVAR") & Sep & dbfPrice.Fields("SROK") & Sep & dbfSum("Summ")
  ...
  dbfPrice.MoveNext
    ...
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("TOVAR") & Sep & dbfPrice.Fields("TOVAR") & Sep & dbfPrice.Fields("IZGOT") & Sep & dbfPrice.Fields("STRANA") & Sep &_
	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL") & Sep & Sep & dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL")-dbfPrice.Fields("SUMMA")/dbfPrice.Fields("KOL")/(dbfPrice.Fields("STAVKANDS")+100)*dbfPrice.Fields("STAVKANDS") & Sep &_
		Sep & "0" & Sep & Sep & dbfPrice.Fields("GTD") & Sep &_
		dbfPrice.Fields("SERTIF") & "^" & dbfPrice.Fields("SERTIF_S") & "^" & dbfPrice.Fields("SERTIF_DO") &_
		Sep & dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROK") & Sep &_
		Sep & Sep & dbfPrice.Fields("CENAREE") & Sep &_
