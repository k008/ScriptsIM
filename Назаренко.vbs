...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=xlWbk.getCellByPosition(6,12).String & Sep & xlWbk.getCellByPosition(8,12).String & Sep & ""

  DeviceOut.WriteLine(St)
  DeviceOut.WriteLine "[Body]"
  i=18 
  Do While xlWbk.getCellByPosition(17,i).String<>""
      if InStr(xlWbk.getCellByPosition(17,i).String,"Сумма") then
        i=i+3
      end if	
      if Not ((xlWbk.getCellByPosition(15,i).String="Х") or InStr(xlWbk.getCellByPosition(17,i).String,"Страница")>0) then
        St=xlWbk.getCellByPosition(4,i).String & Sep & xlWbk.getCellByPosition(1,i).String & Sep &  Sep & Sep &_
	    Replace(xlWbk.getCellByPosition(11,i).String," ","") & Sep & Replace(xlWbk.getCellByPosition(12,i).String," ","") & Sep & Sep & Replace(xlWbk.getCellByPosition(12,i).String,",",".") & Sep &_
		Sep & "0" & Sep & Sep & Sep & Sep & Sep & Sep & Sep &_
		Sep & Sep & Sep & Sep & Replace(xlWbk.getCellByPosition(17,i).String," ","") & Sep
        i = i+1
