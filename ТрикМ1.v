...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("NDOC") & Sep & dbfPrice.Fields("DATEDOC") & Sep & dbfPrice.Fields("SUMPAY")
  St=Convert866to1251(St)
  DeviceOut.WriteLine(St)
  DeviceOut.WriteLine "[Body]"
    Do While Not dbfPrice.Eof
      St= Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("FIRM") & Sep & dbfPrice.Fields("CNTR") & Sep &_
	    dbfPrice.Fields("QNT") & Sep & dbfPrice.Fields("PRICE2") & Sep & dbfPrice.Fields("PRICE1") & Sep & dbfPrice.Fields("PRICE2N") & Sep &_
		Sep & dbfPrice.Fields("PRCOPT") & Sep & Sep & dbfPrice.Fields("NUMGTD") & Sep & dbfPrice.Fields("SER") & "^" &_
		dbfPrice.Fields("SERTIF") & "^" & dbfPrice.Fields("SERTDATE") & "^" & dbfPrice.Fields("SERTORG") & Sep & dbfPrice.Fields("SER") &_
		Sep & Sep & dbfPrice.Fields("SERTDATE") & Sep & Sep & dbfPrice.Fields("DATEPRC") & Sep & dbfPrice.Fields("REGPRC") & Sep &_
		Sep & dbfPrice.Fields("QNT")*dbfPrice.Fields("PRICE2") & Sep & dbfPrice.Fields("GNVLS")
