...
'    msgbox("FF: " & FF & Chr(13)&Chr(10) & "Ne: " & FFNew)
  ...
  St=dbfPrice.Fields("NomNakl") & Sep & dbfPrice.Fields("DateNakl") & Sep & dbfSum.Fields("Summ")
    ...
    Pb5=dbfPrice.Fields("Count")
    Pb6=dbfPrice.Fields("CostNDS")
    Pb7=""
    Pb8=dbfPrice.Fields("CostNONDS")
    Pb9=""
    Pb10=dbfPrice.Fields("StavkaNDS")
    Pb11=""
    Pb12=""
    Pb13=dbfPrice.Fields("SERT") & "^" & dbfPrice.Fields("SERTDATE") & "^" & dbfPrice.Fields("SertORG") & "^" & dbfPrice.Fields("SertEND")
    Pb14=""
    Pb15=""
    Pb16=""
    Pb17=dbfPrice.Fields("ShtrihCode")
    Pb18=""
    Pb19=""
    Pb20=""
    Pb21=dbfPrice.Fields("SummaNDS")
    Pb22=""
