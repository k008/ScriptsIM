...
For Each FF in FL
 ...
 'if InStr(LCase(FF.Name),"."&InExt) AND FF.Size<50000 then
  ...
  DeviceOut.WriteLine dbfPrice.Fields("NDOC") & Sep & dbfPrice.Fields("DATEDOC") & Sep & dbfPrice.Fields("SUMPAY")
  DeviceOut.WriteLine "[Body]"
    Do While Not dbfPrice.Eof
    St=dbfPrice.Fields("CODEPST") & Sep & dbfPrice.Fields("NAME") & Sep & dbfPrice.Fields("FIRM") & Sep & dbfPrice.Fields("CNTR") & Sep & dbfPrice.Fields("QNT") & Sep & dbfPrice.Fields("PRICE2") & Sep & Sep & dbfPrice.Fields("PRICE2N") & Sep & Sep & Sep & Sep & dbfPrice.Fields("NUMGTD") & Sep & dbfPrice.Fields("SERTIF")& "^" & dbfPrice.Fields("SERTORG") & "^" & dbfPrice.Fields("SERTGIVE") & "^" & dbfPrice.Fields("SERTDATE") & Sep & dbfPrice.Fields("SER") & Sep & Sep & dbfPrice.Fields("GDATE") & Sep & dbfPrice.Fields("EAN13") & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMS0") & Sep
	  dbfPrice.MoveNext
