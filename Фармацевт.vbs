...
'    msgbox("FF: " & FF & Chr(13)&Chr(10) & "Ne: " & FFNew)
  ...
  dbfSum.Open "SELECT Sum(SUMMA) AS Summ FROM "&TableName 'запрос на расчет суммы по накладной
    St="1-000" & dbfPrice.Fields("NOMERNAKL") & Sep & dbfPrice.Fields("DATENAKL") & Sep & dbfSum.Fields("Summ")
    St=Convert866to1251(St)
    DeviceOut.WriteLine St
    DeviceOut.WriteLine "[Body]"
    
    Do While Not dbfPrice.Eof
    Pb1=dbfPrice.Fields("KODNOM")
    Pb2=dbfPrice.Fields("NAMENOM")
    Pb3=dbfPrice.Fields("PROIZV")
    Pb4=dbfPrice.Fields("STRANA")
    Pb5=dbfPrice.Fields("KOLVO")
    Pb6=dbfPrice.Fields("Price_2")
    Pb7=dbfPrice.Fields("PRICEPROIZ")
    Pb8=dbfPrice.Fields("Price_1")
    Pb9=""
    Pb10=dbfPrice.Fields("NDS")
    Pb11=""
    Pb12=dbfPrice.Fields("GTD")
    Pb13=dbfPrice.Fields("NOMERSERT") & "^" & dbfPrice.Fields("DATEVSERT") & "^" & dbfPrice.Fields("ORGSERT") & "^" & dbfPrice.Fields("DATEENDSER")
    Pb14=dbfPrice.Fields("SERNOMER")
    Pb15=""
    Pb16=dbfPrice.Fields("SROKGODN")
    Pb17=dbfPrice.Fields("STRIHKOD")
    Pb18=""
    Pb19=dbfPrice.Fields("PRI_GNLS")
    Pb20=""
    Pb21=dbfPrice.Fields("SUMMA")
    Pb22=dbfPrice.Fields("ISLIFE")
