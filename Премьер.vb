...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  Do While xlWbk.getCellByPosition(15,i).String<>""
      if InStr(xlWbk.getCellByPosition(15,i).String,"Сумма с") then
        i=i+3
      end if	
      if Not ((xlWbk.getCellByPosition(13,i).String="Х") or InStr(xlWbk.getCellByPosition(15,i).String,"Страница")>0) then
        St=xlWbk.getCellByPosition(1,i).String & Sep & xlWbk.getCellByPosition(1,i).String & Sep & Sep & Sep &_
	    xlWbk.getCellByPosition(10,i).String & Sep & xlWbk.getCellByPosition(15,i).String/xlWbk.getCellByPosition(10,i).String & Sep & Sep & xlWbk.getCellByPosition(12,i).String/xlWbk.getCellByPosition(10,i).String*0.9 & Sep &_
