...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=dbfPrice.Fields("NOMER") & Sep & dbfPrice.Fields("DATE") & Sep & dbfSum("Summ")
  St=Convert866to1251(St)
  DeviceOut.WriteLine St
  DeviceOut.WriteLine "[Body]"
      
    Do While Not dbfPrice.Eof
	  St = dbfPrice("KOD") & Sep & dbfPrice.Fields("NM") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("COUNTRY") & Sep &dbfPrice.Fields("KOLVO") & Sep & dbfPrice.Fields("PRICWNDS") & Sep & dbfPrice.Fields("PRICE_PR") & Sep & dbfPrice.Fields("PRICMNDS") & Sep & Sep & Sep & Sep & dbfPrice.Fields("GTD") & Sep & dbfPrice.Fields("SERTIF") & "^" & Sep & dbfPrice.Fields("SERIA") & Sep & Sep & dbfPrice.Fields("SROKGODN") & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & ""
          St=Convert866to1251(St)
          DeviceOut.WriteLine(St)
	  dbfPrice.MoveNext
