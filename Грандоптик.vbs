 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
      St=dbfPrice.Fields("CODE") & Sep & dbfPrice.Fields("NAME") & Sep & Sep & Sep & dbfPrice.Fields("QNT") & Sep & dbfPrice.Fields("PRICE") & Sep & Sep & dbfPrice.Fields("PRICE") & Sep &_
		Sep & Sep & Sep & Sep & Sep & Sep & Sep & Sep & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMPAY") & Sep & Sep & Sep & Sep 
