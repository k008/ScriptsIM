...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Pb3=dbfPrice.Fields("PROIZ")
    Pb4=dbfPrice.Fields("COUNTRY")
    Pb5=dbfPrice.Fields("KOLVO")
    Pb6=dbfPrice.Fields("PRICE_WO") + dbfPrice.Fields("PRICE_WO")/100*dbfPrice.Fields("PCT_NDS")
    Pb7=""
    ...
    Pb13=dbfPrice.Fields("SERT") & "^" &  dbfPrice.Fields("SERTORG") & "^" & dbfPrice.Fields("BEGIN_D") & "^"
