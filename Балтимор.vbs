...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  St=TableName & Sep & dbfPrice.Fields("DATE_DOC") & Sep & dbfSum("Summ")
  St=Convert866to1251(St)
  DeviceOut.WriteLine St
  DeviceOut.WriteLine "[Body]"
  
    Do While Not dbfPrice.Eof
	  St = dbfPrice("KOD") & Sep & ReplaceStr(Replace(dbfPrice.Fields("NAME"),Chr(13),""),Chr(10)," ") & Sep & dbfPrice.Fields("PROIZV") & Sep & dbfPrice.Fields("COUNTRY") & Sep &_
		...
		ReplaceStr(dbfPrice.Fields("SERTIF"),";",",") & "^" & ReplaceStr(dbfPrice.Fields("REG_NUM"),";",",") & Sep &_
		dbfPrice.Fields("SERII") & Sep & Sep & dbfPrice.Fields("SROK") & Sep & Sep & Sep &_
