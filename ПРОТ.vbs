 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
          St=dbfPrice.Fields("NOM") & Sep & dbfPrice.Fields("NOM") & Sep & Sep & Sep &_
	    dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("CEN") & Sep & Sep & dbfPrice.Fields("CEN") & Sep &_
		Sep & "0" & Sep & Sep & Sep & Sep & Sep & Sep & Sep &_
		Sep & Sep & Sep & Sep & dbfPrice.Fields("SUM") & Sep
