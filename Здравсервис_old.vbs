 ...
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  DeviceOut.WriteLine "[Body]"
    ...
    Do While Not dbfPrice.Eof
          St=dbfPrice.Fields("ID")&Sep & dbfPrice.Fields("NAME_TV") & Sep & dbfPrice.Fields("IZGOT") & Sep & dbfPrice.Fields("STRANA") & Sep &_
  	        dbfPrice.Fields("KOL") & Sep & dbfPrice.Fields("SUMMA")/(dbfPrice.Fields("KOL")) & Sep & Sep & (dbfPrice.Fields("SUMMA")-(dbfPrice.Fields("SUMMA")*dbfPrice.Fields("NDS")/(dbfPrice.Fields("NDS")+100)))/dbfPrice.Fields("KOL") & Sep &_
		Sep & Sep & Sep & Sep & dbfPrice.Fields("PROT") & "^" & dbfPrice.Fields("DATA_SER") & Sep & dbfPrice.Fields("SER") & Sep & Sep & dbfPrice.Fields("DATA_GOOD") & Sep & dbfPrice.Fields("EAN13") & Sep & Sep & Sep & Sep & dbfPrice.Fields("SUMMA") & Sep & dbfPrice.Fields("GV")
	  dbfPrice.MoveNext
