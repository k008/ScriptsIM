...
For Each FF in FL
 if InStr(LCase(FF.Name),"."&InExt) then
  ...
  i=18 
  Do While xlWbk.getCellByPosition(11,i).String<>""
      if InStr(xlWbk.getCellByPosition(11,i).String,"Цена") then
        i=i+3
      end if	
      if Not ((xlWbk.getCellByPosition(11,i).String="Х") or InStr(xlWbk.getCellByPosition(11,i).String,"Страница")>0) then
        St=xlWbk.getCellByPosition(1,i).String & Sep & xlWbk.getCellByPosition(1,i).String & Sep & Sep & Sep &_
	    xlWbk.getCellByPosition(10,i).String & Sep & xlWbk.getCellByPosition(11,i).String & Sep & Sep & (xlWbk.getCellByPosition(11,i).String)-(xlWbk.getCellByPosition(14,i).String)/(xlWbk.getCellByPosition(10,i).String) & Sep &_
		Sep & Sep & "0" & Sep & Sep & Sep & Sep & Sep & Sep &_
		Sep & Sep & Sep & Sep & xlWbk.getCellByPosition(15,i).String & Sep
        i = i+1
