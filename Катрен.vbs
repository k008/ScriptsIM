...
'    msgbox("FF: " & FF & Chr(13)&Chr(10) & "Ne: " & FFNew)
  ...
  St=dbfPrice.Fields("DOCNUMBER") & Sep & dbfPrice.Fields("DATENUMBER") & Sep & dbfPrice.Fields("FULLSUM")
    St=Convert866to1251(St)
    DeviceOut.WriteLine St
    DeviceOut.WriteLine "[Body]"
    
    Do While Not dbfPrice.Eof
    Pb1=dbfPrice.Fields("GoodId")
    Pb2=dbfPrice.Fields("GoodsName")
    Pb3=dbfPrice.Fields("FirmName")
    Pb4=dbfPrice.Fields("Country")
    Pb5=dbfPrice.Fields("Quantity")
    Pb6=dbfPrice.Fields("Price")
    Pb7=dbfPrice.Fields("VendPrice")
    Pb8=dbfPrice.Fields("SumNoNDS")/Pb5
    Pb9=""
    Pb10=dbfPrice.Fields("ExtraPerc")
    Pb11=""
    Pb12=dbfPrice.Fields("GTD")
    Pb13=dbfPrice.Fields("Numcert") & "^" & dbfPrice.Fields("BegDCert") & " " & dbfPrice.Fields("SertCenter") & "^" & dbfPrice.Fields("EndDCert") & "^" & dbfPrice.Fields("RgRegistr")
    Pb14=dbfPrice.Fields("Series")
    Pb15=""
    Pb16=dbfPrice.Fields("DateLife")
    Pb17=dbfPrice.Fields("BarCode")
    Pb18=""
    Pb19=dbfPrice.Fields("ReestrCur")
    Pb20=""
    Pb21=dbfPrice.Fields("SUM")
    Pb22=dbfPrice.Fields("Vitimport")
...
Function CheckLenTableName()
  ...
  If Len(TableName)>8 Then
    msgbox ("Необходимо уменьшить имя накладной до 8-ми символов перед '.dbg'. Количество символов=" & Len(TableName) & Chr(13)&Chr(10) & "Будет крах, звонить 911 с корпоративного телефона")
  End If
End Function